...
class RegisterPageMobile extends StatefulWidget {
  ...
  @override
  State<RegisterPageMobile> createState() => RegisterPageMobileState();
}

class RegisterPageMobileState extends State<RegisterPageMobile> {
  //formkey
  ...
  if (user != null) {
    ...
    await FirebaseFirestore.instance
        ...
        .then((value) {
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) =>  userDashboardMobile(gmail: EmailController.text.toLowerCase(),)));
        })
        .catchError((error) {
