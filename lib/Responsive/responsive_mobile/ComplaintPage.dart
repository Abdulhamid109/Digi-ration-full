...
class ComplaintPageMobile extends StatefulWidget {
  final String gmail;
  const ComplaintPageMobile({super.key,required this.gmail});

  @override
  State<ComplaintPageMobile> createState() => _ComplaintPageMobileState();
}

class _ComplaintPageMobileState extends State<ComplaintPageMobile> {
  ...
  void addCompliant(String issue) async{
    await FirebaseFirestore.instance.collection('UserComplaints').add({
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context)=> ComplaintsRecordMobile(gmail: widget.gmail,)));
    });
  }
