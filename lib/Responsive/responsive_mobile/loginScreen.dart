...
import 'package:newdigiration/Responsive/responsive_mobile/SignUpScreen.dart';
import 'package:newdigiration/Responsive/responsive_mobile/UserDashboard.dart';
...
class _LoginScreenMobileState extends State<LoginScreenMobile> {
  ...
  void firbaseLogin(String email, String password)async{
    ...
    await FirebaseAuth.instance.signInWithEmailAndPassword(
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) =>  userDashboardMobile(gmail: usernameController.text.toLowerCase(),)));
    }).catchError((e){
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const RegisterPageMobile())),
                        child: Text(
                          "SignUp",
                          style: GoogleFonts.abel(
                              fontSize: 20,
