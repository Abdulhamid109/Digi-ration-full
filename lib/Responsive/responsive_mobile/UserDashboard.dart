...
class userDashboardMobile extends StatefulWidget {
  final String gmail;
  const userDashboardMobile({super.key,required this.gmail});
...
class _userDashboardMobileState extends State<userDashboardMobile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    //item 1
                    GestureDetector(
                      onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context)=> BookSlot(gmail:widget.gmail ,))),
                      child: Column(
                        children: [
                          Card(
                    ...
                    GestureDetector(
                      onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>  ComplaintPageMobile(gmail: widget.gmail,))),
                      child: Column(
                        children: [
                          Card(
                            shadowColor: Colors.lightGreen,
      ...
      //Drawer
      drawer:  UserMenu(gmail: widget.gmail,),
