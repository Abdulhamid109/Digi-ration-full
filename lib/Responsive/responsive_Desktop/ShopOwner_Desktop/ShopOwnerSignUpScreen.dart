...
import 'package:newdigiration/Responsive/responsive_Desktop/ShopOwner_Desktop/ShopOwnerLoginDesktop.dart';
import 'package:newdigiration/Responsive/responsive_Desktop/UserDashboard.dart';
// import 'package:http/http.dart' as http;

class ShopOwnerRegisterPageDesktop extends StatefulWidget {
  const ShopOwnerRegisterPageDesktop({super.key});

  @override
  State<ShopOwnerRegisterPageDesktop> createState() => ShopOwnerRegisterPageDesktopState();
}

class ShopOwnerRegisterPageDesktopState extends State<ShopOwnerRegisterPageDesktop> {
  //formkey
  ...
  if (user != null) {
    ...
    await FirebaseFirestore.instance
        ...
        .then((value) {
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) =>  userDashboardDesktop(mgmail: EmailController.text.toLowerCase(),)));
        })
        .catchError((error) {
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color.fromARGB(255, 65, 202, 70),
                      ...
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const ShopOwnerLoginDesktop())),
                          child: Text(
                            "Login",
                            style: GoogleFonts.abel(
                                fontSize: 20,
