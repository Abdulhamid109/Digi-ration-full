...
class ComplaintsRecordDesktop extends StatefulWidget {
  final String gmail;
  const ComplaintsRecordDesktop({super.key,required this.gmail});

  @override
  State<ComplaintsRecordDesktop> createState() => _ComplaintsRecordDesktopState();
}

class _ComplaintsRecordDesktopState extends State<ComplaintsRecordDesktop> {
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () => Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) =>
                                               ComplaintPageDesktop(gmail:widget.gmail ,))),
                                  child: Container(
                                    height: 50,
                                    width: 150,
